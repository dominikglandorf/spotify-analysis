...
\subsection{Analysis}
% explain what analysis we conducted and WHY
...
% PCA: ability to inspect the data in a visual way, try to find out if there is a underlying structure and how it relates to the initial dimensions, interested in possible clusters or variance differences, PCA itself is agnostic of our label!
...
% here we have a supervised problem since we test our two handcrafted groups

\subsection{Results}
Tested against the Bonferroni-corrected critical F value [5] of these tests turned out significantly, whereas the rest remained above the threshold. % which audio features are significant?
