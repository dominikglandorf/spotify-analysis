...
\begin{table}[h!]
  \begin{center}
    ...
    \label{tab:table1}
    \begin{tabular}{l|c|S} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
      \textbf{No.} & \textbf{Feature} & \textbf{F-value}\\
      %$.$ & $Feature$ & $F-value$ \\
      \hline
      1 & danceability        &  2.507103**\\
	  2 & energy              &  2.263637**\\
	  3 & liveness            &  1.232870\\
	  4 & loudness            &  9.271733**\\
